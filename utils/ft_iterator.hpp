...
namespace ft {
    ...
    template <typename Iterator>
    vector_iterator<Iterator>                           operator+(typename vector_iterator<Iterator>::difference_type n, const vector_iterator<Iterator>& vec_it) {
        return vector_iterator<Iterator>(vec_it.base() + n);
    };
    template <typename Iterator>
